...
function( copyWithSymLink SRC DST )
	if( WBR_SKIP_CONFIGURE_DLL_COPY )
		message( STATUS "WBR configure-only pass: skipping DLL copy ${SRC} -> ${DST}" )
		return()
	endif()
	if( NOT APPLE )
		if( UNIX )
...
if( NOT IOS )
	...
	if( WBR_DEPS_ROOT )
		message( STATUS "WBR configure-only pass: using verified Ogre deps SDL2 paths" )
		include_directories( "${WBR_DEPS_ROOT}/Ogre/ogre-next-deps/src/SDL2/include" )
	else()
		find_package( SDL2 )
		if( NOT SDL2_FOUND )
